...
namespace ClashRoyale.Utilities.Netty
{
    ...
    public static class Writer
    {
        ...
        /// <param name="buffer"></param>
        /// <param name="value"></param>
        public static void WriteVLong(this IByteBuffer buffer, long value)
        {
            var temp = (value >> 57) & 0x40;
            var flipped = value ^ (value >> 63);
            ...
            buffer.WriteByte((byte)(temp | 0x80));

            do
            {
                buffer.WriteByte((byte)((value & 0x7F) | ((flipped >>= 7) != 0 ? 0x80 : 0)));
                value >>= 7;
            } while (flipped != 0);
        }
